    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { label: '📦 Produtos', slug: 'modulos/produtos/produtos' },
            { label: '👥 Clientes', slug: 'modulos/clientes/clientes' },
            { label: '💰 Custos', slug: 'modulos/custos/custos' },
            { label: '📋 Pedidos', slug: 'modulos/pedidos/pedidos' },
            { label: '🏭 Produção', slug: 'modulos/producao/producao' },
            {
              label: '🚚 Expedição',
              collapsed: true,
              items: [
                { label: 'Expedição', slug: 'modulos/expedicao/expedicao' },
                {
                  label: '📄 NFe Débitos',
                  collapsed: true,
                  items: [
            ...
            { label: '🛒 Compras', slug: 'modulos/compras/compras' },
            { label: '📥 Recebimento', slug: 'modulos/recebimento/recebimento' },
            { label: '👤 Pessoas', slug: 'modulos/pessoas/pessoas' },
            { label: '🌐 Marketplace', slug: 'modulos/marketplace/marketplace' },
            { label: '📊 Indicadores', slug: 'modulos/indicadores/indicadores' },
            { label: '📁 Arquivos', slug: 'modulos/arquivos/arquivos' },
            { label: '⚙️ Extras', slug: 'modulos/extras/extras' },
          ],
        },
        {
